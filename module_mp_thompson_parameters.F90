module module_mp_thompson_parameters
    ...
    logical :: is_aerosol_aware = .false.
...
!.. calculated as function of ice water content and temperature.
 ...
 !.. Snow from Field et al. (2005), others assume spherical form.
    real(wp), parameter :: am_r = PI*rho_w/6.0
...
!..Capacitance of sphere and plates/aggregates: D**3, D**2
 ...
 !   real(wp), parameter :: RoverRv = R*oRv
    real(wp), parameter :: Cp = 1004.0
...
!> Lookup tables for cloud water content (kg/m**3).
 ...
 !.. cloud ice, rain, snow, then graupel).
    ...
    real(wp), dimension(18) :: cse, csg
    real(wp) :: oams, obms, ocms
    real(wp), dimension(12) :: cge, cgg
    real(wp) :: oge1, ogg1, ogg2, ogg3, oamg, obmg, ocmg
...
end module module_mp_thompson_parameters